  ...
  var MentionsInput = function (settings) {
    ...
    function populateDropdown(query, results) {
      ...
      _.each(results, function (item, index) {
        ...
        autocompleteItemCollection[itemUid] = _.extend({}, item, {value: settings.triggerChar+item.name}); //Inserts the new item to autocompleteItemCollection // modified for donut
