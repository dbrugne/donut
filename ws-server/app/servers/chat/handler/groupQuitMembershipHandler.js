...
handler.call = function (data, session, next) {
  ...
  async.waterfall([
    ...
    function broadcastToUser (callback) {
      ...
      that.app.globalChannelService.pushMessage('connector', 'group:quit:membership', event, 'user:' + user.id, {}, function (err) {
        return callback(err);
      });
    },
    ...
    if (err) {
      return errors.getHandler('group:quit:membership', next)(err);
    }
