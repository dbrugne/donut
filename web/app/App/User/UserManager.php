...
class UserManager implements UserProviderInterface
{
     ...
     * @return User
     */
    public function createUser($username, $plainPassword, $email, $roles = array())
    {
    ...
    {
        $sql = 'INSERT INTO users (email, password, salt, username, roles, time_created) VALUES (:email, :password, :salt, :username, :roles, :timeCreated) ';
