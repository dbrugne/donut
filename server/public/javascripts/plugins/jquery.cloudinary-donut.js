/****************************************************************************
 *
 *      /!\/!\/!\  Duplicate code in app/cloudinary.js !!  /!\/!\/!\
 *
 ***************************************************************************/
(function($){
  ...
  $.cd = {
    roomAvatar: function(identifier, size, background) {
      return _url(identifier, roomAvatarDefault, size, size, background);
    },
    userAvatar: function(identifier, size, background) {
    ...
    poster: function(identifier, background) {
      ...
      return _url(identifier, '', 430, 1100, background, 'center');
    },
    posterBlured: function(identifier, background, blured) {
      if (!identifier)
        return '';

      return _url(identifier, '', 430, 1100, background, 'center', 'blur:800');
    }
  };
})(jQuery);